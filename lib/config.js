 ...
 * Create config
 */
exports.createConf = function (defaultValue, type) {
  logger.info('This info only save in local ~/.sendrc file.')
  let questions
  switch (type) {
    case 'gitlab':
      questions = [
        { type: 'text', name: 'GITLAB_USER_NAME', message: 'Your gitlab user name?' },
        { type: 'text', name: 'GITLAB_USER_PASS', message: 'Your gitlab user pass?' }
      ]
      break
